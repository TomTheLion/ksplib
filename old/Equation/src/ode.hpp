void de(void f(double t, double y[], double yp[], void* params), int neqn, double y[],
	...
	int &isnold, void* params);
int i4_sign(int i);
void intrp(double x, double y[], double xout, double yout[], double ypout[],
	int neqn, int kold, double phi[], double psi[]);
void ode(void f(double t, double y[], double yp[], void* params), int neqn, double y[],
	double &t, double tout, double &relerr, double &abserr, int &iflag,
	double work[], int iwork[], void* params);
double r8_epsilon();
double r8_max(double x, double y);
double r8_min(double x, double y);
double r8_sign(double x);
void step(double &x, double y[], void f(double t, double y[], double yp[], void* params),
	...
	double w[], double g[], bool &phase1, int &ns, bool &nornd, void* params);
//void timestamp ( );
